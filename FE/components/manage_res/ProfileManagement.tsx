    ...
    return (
        <div>
            ...
            <div className="flex items-start gap-6">
                <img src={profile.image} alt={profile.name} className="w-40 h-40 object-cover rounded-lg border" />
                ...
                {isEditing ? (
                    <>
                        ...
                        <div className="space-x-2 mt-2">
                            ...
                            <button onClick={() => { setEditData(profile); setIsEditing(false); }} className="px-4 py-2 bg-gray-500 text-white rounded">Hủy</button>
                        </div>
                    </>
                ) : (
