...
import com.grabdriver.fe.services.LocationService;
import com.grabdriver.fe.services.OrderUpdateService;
        ...
        apiManager.getAuthRepository().logout(new ApiRepository.NetworkCallback<Void>() {
            ...
            public void onError(String errorMessage) {
                runOnUiThread(() -> {
                    ...
                    // Vẫn xóa thông tin đăng nhập và chuyển đến màn hình đăng nhập kể cả khi API
                    // lỗi
