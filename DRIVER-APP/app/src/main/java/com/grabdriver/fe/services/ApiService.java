...
import com.grabdriver.fe.models.request.AcceptOrderRequest;
import com.grabdriver.fe.models.response.ApiResponse;
import com.grabdriver.fe.models.response.DriverOrderResponse;
import com.grabdriver.fe.models.response.EarningsResponse;
import com.grabdriver.fe.models.request.FeedbackRequest;
import com.grabdriver.fe.models.request.LocationUpdateRequest;
...
import com.grabdriver.fe.models.response.OrderResponse;
import com.grabdriver.fe.models.ProfileStatistics;
import com.grabdriver.fe.models.request.RejectOrderRequest;
import com.grabdriver.fe.models.Reward;
import com.grabdriver.fe.models.response.RewardResponse;
import com.grabdriver.fe.models.Shipper;
import com.grabdriver.fe.models.ShipperProfileUpdate;
import com.grabdriver.fe.models.Transaction;
import com.grabdriver.fe.models.request.UpdateStatusRequest;
import com.grabdriver.fe.models.Wallet;
import com.grabdriver.fe.models.request.WithdrawRequest;
...
public interface ApiService {
    ...
    Call<ApiResponse<List<DriverOrderResponse>>> getOrderHistory(@Query("page") int page, @Query("size") int size,
    ...
    Call<ApiResponse<Order>> updateOrderStatus(@Path("orderId") long orderId, @Query("status") String status,
    ...
    Call<ApiResponse<List<Transaction>>> getTransactionsByType(@Query("type") String type, @Query("page") int page,
            @Query("size") int size);
