...
public class OrderRepository extends ApiRepository {
    ...
    public void getOrderHistory(int page, int size, NetworkCallback<OrderResponse> callback) {
        Call<ApiResponse<List<DriverOrderResponse>>> call = getApiService().getOrderHistory(page, size,
                new HashMap<>());
        executeCall(call, new NetworkCallback<List<DriverOrderResponse>>() {
            @Override
            public void onSuccess(List<DriverOrderResponse> driverOrders) {
    ...
    public void getOrderHistory(int page, int size, Map<String, String> filters,
            NetworkCallback<OrderResponse> callback) {
    ...
    // Chấp nhận đơn hàng
    public void acceptOrder(long orderId, String pickupTime, String deliveryTime, String note,
            NetworkCallback<Order> callback) {
