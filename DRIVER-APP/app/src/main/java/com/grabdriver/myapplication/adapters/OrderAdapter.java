    ...
    class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Order order) {
            ...
            if (order.getShippingFee() != null) {
                ...
                shippingFeeText
                        .setText(itemView.getContext().getString(R.string.order_shipping_fee_prefix, formattedFee));
            } else {
            ...
            if (order.getDistance() != null) {
                distanceText
                        .setText(itemView.getContext().getString(R.string.order_distance_format, order.getDistance()));
            } else {
            ...
            if (order.getEstimatedTime() != null && order.getEstimatedTime() > 0) {
                estimatedTimeText
                        .setText(itemView.getContext().getString(R.string.order_time_format, order.getEstimatedTime()));
            } else {
