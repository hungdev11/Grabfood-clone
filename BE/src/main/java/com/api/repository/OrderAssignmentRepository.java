...
public interface OrderAssignmentRepository extends JpaRepository<OrderAssignment, Long> {
    ...
    Optional<OrderAssignment> findByOrderIdAndShipperId(@Param("orderId") Long orderId, @Param("shipperId") Long shipperId);
    ...
    List<OrderAssignment> findByShipperIdAndStatus(@Param("shipperId") Long shipperId, @Param("status") OrderAssignment.AssignmentStatus status);
